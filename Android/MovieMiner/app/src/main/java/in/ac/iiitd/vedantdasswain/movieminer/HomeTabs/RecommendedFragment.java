 ...
 */
public class RecommendedFragment extends Fragment implements OnGetMoviesTaskCompleted {
...
//        pd=ProgressDialog.show(this,"Loading","Fetching your movies...");
    ...
    private void setupRecyclerView() {
        movieRecyclerView=(RecyclerView)rootView.findViewById(R.id.recommended_movie_recycler_view);
