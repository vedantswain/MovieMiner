...
class AttachedDisk(messages.Message):
  ...
  Enums:
    DiskEncryptionKeySourceValueValuesEnum: [Output Only] Indicates the source
      of encryption key, either DEFAULT, which means the key was generated
      automatically by Compute Engine, or CUSTOMER, which means a customer-
      supplied encryption key was used.
  ...
  Fields:
    ...
    diskEncryptionKey: Specifies the customer-supplied encryption key to
      ...
      generated key.  Format: 256-bit string encoded in Base 64 (RFC4648)
    diskEncryptionKeySource: [Output Only] Indicates the source of encryption
      key, either DEFAULT, which means the key was generated automatically by
      Compute Engine, or CUSTOMER, which means a customer-supplied encryption
      key was used.
  ...
  class DiskEncryptionKeySourceValueValuesEnum(messages.Enum):
    """[Output Only] Indicates the source of encryption key, either DEFAULT,
    which means the key was generated automatically by Compute Engine, or
    CUSTOMER, which means a customer-supplied encryption key was used.
  ...
  diskEncryptionKey = messages.StringField(4)
  diskEncryptionKeySource = messages.EnumField('DiskEncryptionKeySourceValueValuesEnum', 5)
  diskMasterKey = messages.StringField(6)
  index = messages.IntegerField(7, variant=messages.Variant.INT32)
  initializeParams = messages.MessageField('AttachedDiskInitializeParams', 8)
  interface = messages.EnumField('InterfaceValueValuesEnum', 9)
  kind = messages.StringField(10, default=u'compute#attachedDisk')
  licenses = messages.StringField(11, repeated=True)
  mode = messages.EnumField('ModeValueValuesEnum', 12)
  source = messages.StringField(13)
  type = messages.EnumField('TypeValueValuesEnum', 14)
...
class AttachedDiskInitializeParams(messages.Message):
  ...
  Fields:
    ...
    sourceImageEncryptionKey: Specifies the customer-supplied encryption key
      ...
      is provided the request will fail.  Format: 256-bit string encoded in
      Base 64 (RFC4648)
  ...
  sourceImageEncryptionKey = messages.StringField(6)
  sourceImageMasterKey = messages.StringField(7)
...
class Disk(messages.Message):
  ...
  Fields:
    ...
    sourceSnapshotEncryptionKey: Specifies the customer-supplied encryption
      ...
      key is provided the request will fail.  Format: 256-bit string encoded
      in Base 64 (RFC4648)
  ...
  diskEncryptionKey = messages.StringField(3)
  diskEncryptionKeySource = messages.EnumField('DiskEncryptionKeySourceValueValuesEnum', 4)
  diskMasterKey = messages.StringField(5)
  id = messages.IntegerField(6, variant=messages.Variant.UINT64)
  kind = messages.StringField(7, default=u'compute#disk')
  ...
  sourceImageEncryptionKey = messages.StringField(14)
  sourceImageId = messages.StringField(15)
  sourceImageMasterKey = messages.StringField(16)
  sourceSnapshot = messages.StringField(17)
  sourceSnapshotEncryptionKey = messages.StringField(18)
  sourceSnapshotId = messages.StringField(19)
  sourceSnapshotMasterKey = messages.StringField(20)
  status = messages.EnumField('StatusValueValuesEnum', 21)
  storageType = messages.EnumField('StorageTypeValueValuesEnum', 22)
  type = messages.StringField(23)
  zone = messages.StringField(24)
...
class Image(messages.Message):
  ...
  Enums:
    ImageEncryptionKeySourceValueValuesEnum: [Output Only] Indicates the
      source of encryption key, either DEFAULT, which means the key was
      generated automatically by Compute Engine, or CUSTOMER, which means a
      customer-supplied encryption key was used.
  ...
  Fields:
    ...
    imageEncryptionKey: Specifies the customer-supplied encryption key to
      protect the image.  When attempting to use an image that is protected by
      ...
      generated key.  Format: 256-bit string encoded in Base 64 (RFC4648)
    imageEncryptionKeySource: [Output Only] Indicates the source of encryption
      key, either DEFAULT, which means the key was generated automatically by
      Compute Engine, or CUSTOMER, which means a customer-supplied encryption
      key was used.
    ...
    sourceDiskEncryptionKey: Specifies the customer-supplied encryption key of
      ...
      the request will fail.  Format: 256-bit string encoded in Base 64
      (RFC4648)
  ...
  class ImageEncryptionKeySourceValueValuesEnum(messages.Enum):
    """[Output Only] Indicates the source of encryption key, either DEFAULT,
    which means the key was generated automatically by Compute Engine, or
    CUSTOMER, which means a customer-supplied encryption key was used.
  ...
  id = messages.IntegerField(6, variant=messages.Variant.UINT64)
  imageEncryptionKey = messages.StringField(7)
  imageEncryptionKeySource = messages.EnumField('ImageEncryptionKeySourceValueValuesEnum', 8)
  imageMasterKey = messages.StringField(9)
  kind = messages.StringField(10, default=u'compute#image')
  licenses = messages.StringField(11, repeated=True)
  name = messages.StringField(12)
  rawDisk = messages.MessageField('RawDiskValue', 13)
  selfLink = messages.StringField(14)
  sourceDisk = messages.StringField(15)
  sourceDiskEncryptionKey = messages.StringField(16)
  sourceDiskId = messages.StringField(17)
  sourceDiskMasterKey = messages.StringField(18)
  sourceType = messages.EnumField('SourceTypeValueValuesEnum', 19, default=u'RAW')
  status = messages.EnumField('StatusValueValuesEnum', 20)
...
class Snapshot(messages.Message):
  ...
  Enums:
    SnapshotEncryptionKeySourceValueValuesEnum: [Output Only] Indicates the
      source of encryption key, either DEFAULT, which means the key was
      generated automatically by Compute Engine, or CUSTOMER, which means a
      customer-supplied encryption key was used.
  ...
  Fields:
    ...
    snapshotEncryptionKey: Specifies the customer-supplied encryption key to
      ...
      provided at creation, then the snapshot will be encrypted using an
      automatically generated key.  Format: 256-bit string encoded in Base 64
      (RFC4648)
    snapshotEncryptionKeySource: [Output Only] Indicates the source of
      encryption key, either DEFAULT, which means the key was generated
      automatically by Compute Engine, or CUSTOMER, which means a customer-
      supplied encryption key was used.
  ...
  class SnapshotEncryptionKeySourceValueValuesEnum(messages.Enum):
    """[Output Only] Indicates the source of encryption key, either DEFAULT,
    which means the key was generated automatically by Compute Engine, or
    CUSTOMER, which means a customer-supplied encryption key was used.
  ...
  name = messages.StringField(7)
  selfLink = messages.StringField(8)
  snapshotEncryptionKey = messages.StringField(9)
  snapshotEncryptionKeySource = messages.EnumField('SnapshotEncryptionKeySourceValueValuesEnum', 10)
  snapshotMasterKey = messages.StringField(11)
  sourceDisk = messages.StringField(12)
  sourceDiskEncryptionKey = messages.StringField(13)
  sourceDiskId = messages.StringField(14)
  sourceDiskMasterKey = messages.StringField(15)
  status = messages.EnumField('StatusValueValuesEnum', 16)
  storageBytes = messages.IntegerField(17)
  storageBytesStatus = messages.EnumField('StorageBytesStatusValueValuesEnum', 18)
