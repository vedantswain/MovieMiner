...
class _Make(BigqueryCmd):
  ...
  def RunWithArgs(self, identifier='', schema=''):
    ...
    if isinstance(reference, DatasetReference):
      ...
      if self.defaultTableExpiration is not None:
        default_table_exp_ms = self.defaultTableExpiration * 1000
      ...
      if schema:
        ...
        schema = None
      expiration = None
      if self.defaultTableExpiration:
